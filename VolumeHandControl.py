...
while True:
    ...
    if len(lmList) != 0:
        ...
        cv2.putText(img, f'length:{int(length)}', (20, 70), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)

        vol = np.interp(length, [50, 300],[minVol, maxVol])
        volBar = np.interp(length, [50, 300], [400, 150])
        volPer = np.interp(length, [50, 300], [0, 100])

        cv2.putText(img, f'Volume:{int(volPer)} % ', (20, 110), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 1)
